...
<head>
  ...
  <!-- Load fonts.com -->
  <!-- <script type="text/javascript" src="//fast.fonts.net/jsapi/524cbc66-b7fa-49b0-b990-0ad169e05b9f.js"></script> -->
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZWRJWKN5K4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZWRJWKN5K4');
</script>
